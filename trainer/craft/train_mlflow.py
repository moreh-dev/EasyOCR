...
class Trainer(object):
    ...
    def train(self, buffer_dict):
        ...
        experiment_id = mlflow.create_experiment('{}_{}'.format('easyocr_detection_model_craft', current_datetime))
        experiment = mlflow.get_experiment(experiment_id)
        mlflow_runner = mlflow.start_run(run_name='easyocr_detection_model_craft', experiment_id=experiment.experiment_id)
        # TRAIN -------------------------------------------------------------------------------------------------------#
